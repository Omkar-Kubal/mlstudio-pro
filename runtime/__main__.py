...
def main():
    ...
    labs_dir = base_dir / "content" / "labs"
    contracts_dir = base_dir / "contracts"
    reports_dir = base_dir / "reports"
    
    if args.command == "run":
        from runtime.runner import NotebookRunner
        ...
        from runtime.seed_enforcer import SeedEnforcer
        ...
        from runtime.contract_generator import generate_contracts
